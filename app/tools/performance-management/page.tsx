    ...
    <div className="space-y-4">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <h1 className="text-lg font-bold text-gray-900 mt-1.5">Performance Management Targets</h1>
        </div>
        <p className="text-sm text-gray-600 leading-relaxed">
          This tool can be used to draft performance management targets for staff. Simply provide
          the school type, staff role, pay scale, and responsibilities and summary of targets.
        </p>
        <div className="mt-5 pt-5 border-t border-gray-100">
          ...
          <ol className="space-y-3">
            {[
              ...
              "It is important to be specific when entering the responsibilities and targets.",
              "Ideas for use: drafting performance targets for teachers and members of a school's senior leadership team.",
            ].map((tip, i) => (
...
export default function PerformanceManagementPage() {
  return (
    <main className="max-w-7xl mx-auto px-6 py-10">
      <PerformanceManagementForm sidebar={<Sidebar />} />
    </main>
  );
}
