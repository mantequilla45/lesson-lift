    ...
    <div className="space-y-4">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <h1 className="text-lg font-bold text-gray-900 mt-1.5">Sensory Activities</h1>
        </div>
        <p className="text-sm text-gray-600 leading-relaxed">
          This tool can be used to generate ideas for sensory activities relating to a topic.
          Simply enter the year group and topic you are teaching, and the AI will generate
          5 ideas for you with the resources required and senses targeted.
        </p>
        <div className="mt-5 pt-5 border-t border-gray-100">
          ...
          <ol className="space-y-3">
            {[
              ...
              "When entering the topic, use the language as set out in your curriculum.",
              "Ideas for use: generating ideas for sensory activities to support your teaching.",
            ].map((tip, i) => (
...
export default function SensoryActivitiesPage() {
  return (
    <main className="max-w-7xl mx-auto px-6 py-10">
      <SensoryActivitiesForm sidebar={<Sidebar />} />
    </main>
  );
}
