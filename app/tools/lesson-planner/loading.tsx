          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <textarea disabled rows={3} placeholder="e.g. Quadratic equations" className={`${inputClass} resize-none`} />
              </div>
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-gray-700">Learning objective</label>
                <textarea disabled rows={3} placeholder="e.g. Students will be able to factorise and solve quadratic equations" className={`${inputClass} resize-none`} />
              </div>
