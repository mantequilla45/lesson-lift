    ...
    <div className="space-y-4">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <h1 className="text-lg font-bold text-gray-900 mt-1.5">Newsletter Writer</h1>
        </div>
        <p className="text-sm text-gray-600 leading-relaxed">
          This tool will allow you to write a newsletter with the tone of your choice, including
        ...
        <div className="mt-5 pt-5 border-t border-gray-100">
          ...
          <ol className="space-y-3">
            {[
              ...
              "Be specific with the content you would like included in the sections to provide the best possible output.",
              "Ideas for use: generate a newsletter for your whole school, or for your department.",
            ].map((tip, i) => (
...
export default function NewsletterWriterPage() {
  return (
    <main className="max-w-7xl mx-auto px-6 py-10">
      <NewsletterWriterForm sidebar={<Sidebar />} />
    </main>
  );
}
