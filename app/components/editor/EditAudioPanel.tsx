...
import { Loader2, X, Lightbulb, CheckSquare, Pencil } from "lucide-react";
...
export default function EditAudioPanel({ initialActivityType = "comprehension", onClose, onSubmit }: Props) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-5 py-4 border-b" style={{ borderColor: "#EAE6F5" }}>
        <h3 className="text-base font-bold" style={{ color: "#1D1730" }}>Edit audio</h3>
        <button
          onClick={onClose}
          disabled={busy}
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
        <div>
          <p className="text-sm font-bold mb-2" style={{ color: "#1D1730" }}>Type of activity</p>
        ...
        <div>
          <p className="text-sm font-bold mb-2" style={{ color: "#1D1730" }}>
      ...
      <div className="px-5 py-4 border-t" style={{ borderColor: "#EAE6F5" }}>
        <button
          type="button"
