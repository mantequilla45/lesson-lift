          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                placeholder="You can optionally paste content here to guide the response generated by the AI, for example exam spec content or general guidance"
                rows={4}
                className={`${inputClass} resize-none`}
              />
              <p className="text-xs text-gray-400">100,000 character maximum input text</p>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                placeholder="You can provide optional guidelines such as approximate length, or number of paragraphs"
                rows={3}
                className={`${inputClass} resize-none`}
              />
              <p className="text-xs text-gray-400">100,000 character maximum input text</p>
